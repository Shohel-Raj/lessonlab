...
console.log(photo)
  ...
  return (
    <div className="w-20 h-20 rounded-full bg-[#FBD536] flex items-center justify-center text-2xl font-bold text-gray-900 mb-4">
      {firstLetter}
    </div>
  );
};
    ...
    <section>
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
          Recognizing the most active members who are sharing meaningful lessons
          and inspiring growth in our community.
        </p>
